...
describe('ProductAPI', () => {
    ...
    describe('watchCandles', () => {
        ...
        it('throws an error when trying to watch a candle setup multiple times', (done) => __awaiter(void 0, void 0, void 0, function* () {
            const productId = 'BTC-USD';
            const granularity = _1.CandleGranularity.ONE_HOUR;
            nock_1.default(global.REST_URL)
                .get(`${_1.ProductAPI.URL.PRODUCTS}/${productId}/candles`)
        ...
        it('emits new candles', (done) => __awaiter(void 0, void 0, void 0, function* () {
            const productId = 'BTC-USD';
            const granularity = _1.CandleGranularity.ONE_HOUR;
            const updateInterval = 60000;
