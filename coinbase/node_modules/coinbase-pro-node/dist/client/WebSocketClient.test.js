...
describe('WebSocketClient', () => {
    function createWebSocketClient(url = WEBSOCKET_URL) {
        return new WebSocketClient_1.WebSocketClient(url, () => {
    ...
    describe('connect', () => {
        it('attaches an error listener', (done) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            ws.on(WebSocketClient_1.WebSocketEvent.ON_ERROR, done);
            ws.connect();
        }));
    ...
    describe('constructor', () => {
        it('it signals an event when the WebSocket connection is established', (done) => __awaiter(void 0, void 0, void 0, function* () {
            const ws = createWebSocketClient();
            ws.on(WebSocketClient_1.WebSocketEvent.ON_OPEN, () => done());
            ws.connect();
        }));
    });
    describe('disconnect', () => {
    ...
    describe('sendMessage', () => {
        it('does not send a message when there is no active connection', (done) => __awaiter(void 0, void 0, void 0, function* () {
            const ws = createWebSocketClient();
            try {
    ...
    describe('subscribe', () => {
        function mockWebSocketResponse(done, channels, payload) {
            ...
            ws.on(WebSocketClient_1.WebSocketEvent.ON_CLOSE, done);
        ...
        it('receives typed messages from "status" channel', (done) => __awaiter(void 0, void 0, void 0, function* () {
            const channel = {
                name: WebSocketClient_1.WebSocketChannelName.STATUS,
            };
            const ws = mockWebSocketResponse(done, channel, status_json_1.default);
            ws.on(WebSocketClient_1.WebSocketEvent.ON_MESSAGE_STATUS, message => {
        ...
        it('receives typed messages from "ticker" channel', (done) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            ws.on(WebSocketClient_1.WebSocketEvent.ON_MESSAGE_TICKER, tickerMessage => {
                expect(tickerMessage.trade_id).toBe(3526965);
                ws.unsubscribe(channel);
            });
            ws.connect();
        }));
        it('receives typed messages from multiple "matches" channels', (done) => __awaiter(void 0, void 0, void 0, function* () {
            const channels = [
                {
            ...
            const ws = mockWebSocketResponse(done, channels, BTC_USD_json_2.default);
            ws.on(WebSocketClient_1.WebSocketEvent.ON_MESSAGE_MATCHES, message => {
                expect(message.trade_id).toBe(9713921);
                ws.unsubscribe(channels);
            });
            ws.connect();
        }));
        it('receives typed error messages', (done) => __awaiter(void 0, void 0, void 0, function* () {
            server.on('connection', ws => {
                ws.on('message', (message) => {
                    const request = JSON.parse(message);
                    if (request.type === WebSocketClient_1.WebSocketRequestType.SUBSCRIBE) {
            ...
            const ws = createWebSocketClient();
            ws.on(WebSocketClient_1.WebSocketEvent.ON_MESSAGE_ERROR, errorMessage => {
                expect(errorMessage.type).toBe(WebSocketClient_1.WebSocketResponseType.ERROR);
                done();
            });
            ws.on(WebSocketClient_1.WebSocketEvent.ON_OPEN, () => {
                ws.subscribe({
                    name: WebSocketClient_1.WebSocketChannelName.USER,
                    product_ids: ['BTC-USD'],
                });
            });
            ws.connect();
