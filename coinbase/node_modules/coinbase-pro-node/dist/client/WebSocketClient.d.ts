...
import { OrderSide, ISO_8601_MS_UTC, UUID_V4, CurrencyDetail, Product } from '..';
...
declare type WebSocketMessage = Record<string, string | number | boolean> | WebSocketStatusMessage | WebSocketTickerMessage | WebSocketMatchMessage | WebSocketErrorMessage;
